...
public class AltaArticulos extends JFrame 
{
	...
	public AltaArticulos() 
	{
		...
		btnAgregar.setBounds(79, 198, 89, 35);
			...
			public void actionPerformed(ActionEvent e) 
			{
				try
				{
					...
					else
					{
						...
						if(datos.altaArticulo(textFieldDescripcion.getText(), precio, Integer.parseInt(textFieldCantidad.getText())) == true)
						{
